...
(0, vitest_1.test)('Should parse Lambda stack correctly', () => {
    const st = (0, parse_browser_error_stack_1.parseStack)(stack.split('\n'));
    (0, vitest_1.expect)(st).toEqual([
        {
            columnNumber: 46,
            fileName: 'https://remotionlambda-sd60tlwje7.s3.us-east-1.amazonaws.com/sites/testbed/bundle.js',
            functionName: 'Index',
            lineNumber: 60509,
        },
        {
