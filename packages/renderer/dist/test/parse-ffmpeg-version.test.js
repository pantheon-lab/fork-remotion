...
(0, vitest_1.test)('Should parse a normal FFFMPEG version', () => {
    const buildconf = `
  ...
  `;
    (0, vitest_1.expect)((0, ffmpeg_flags_1.parseFfmpegVersion)(buildconf)).toEqual([4, 3, 1]);
});
(0, vitest_1.test)('Should return null if running a git version', () => {
    const buildconf = `
    ffmpeg -version 
  ...
  `;
    (0, vitest_1.expect)((0, ffmpeg_flags_1.parseFfmpegVersion)(buildconf)).toEqual(null);
});
